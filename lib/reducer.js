...
var create = exports.create = function create(state, action, path) {
  ...
  return _lodash2.default.assign({}, state, _lodash2.default.get(action, path));
};
...
var del = exports.del = function del(state, action, path) {
  ...
  var id = _lodash2.default.get(action, ['payload', 'result']);

  return _lodash2.default.omit(_lodash2.default.clone(state), id);
};
