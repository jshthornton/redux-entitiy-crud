...
var create = exports.create = function create(state, action, path) {
  ...
  if (_lodash2.default.isArray(_lodash2.default.get(action, path)) === true) {
    return _lodash2.default.assign({}, state, _lodash2.default.keyBy(_lodash2.default.get(action, path), idKey));
  }

  return _lodash2.default.assign({}, state, _defineProperty({}, _lodash2.default.get(action, path).id, _lodash2.default.get(action, path)));
};
...
var update = exports.update = function update(state, action, path) {
  ...
  if (_lodash2.default.isArray(_lodash2.default.get(action, path)) === true) {
    return _lodash2.default.merge({}, state, _lodash2.default.keyBy(_lodash2.default.get(action, path), idKey));
  }

  return _lodash2.default.merge({}, state, _defineProperty({}, _lodash2.default.get(action, path).id, _lodash2.default.get(action, path)));
};
...
var del = exports.del = function del(state, action, path) {
  ...
  if (_lodash2.default.isArray(_lodash2.default.get(action, path)) === true) {
    return _lodash2.default.omit(_lodash2.default.clone(state), _lodash2.default.map(_lodash2.default.get(action, path), idKey));
  }

  return _lodash2.default.omit(_lodash2.default.clone(state), _lodash2.default.get(action, path).id);
};
